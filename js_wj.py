...
# Form implementation generated from reading ui file 'js_wj.ui'
#
...
def check_posture(landmarks, img):
    try:
        ...
        if left_upper_arm_angle > 60 or right_upper_arm_angle > 60:
            messages.append("动作错误！存在危险！大臂请紧贴躯干")
            draw.text((25, 50), "动作错误！存在危险！大臂请紧贴躯干", font=font, fill=(0, 0, 0))

        if left_elbow_angle > 60 or right_elbow_angle > 60:
            draw.text((25, 80), "请以小臂为轴，缓慢抬起杠铃", font=font, fill=(0, 0, 0))
            messages2.append("请以小臂为轴，缓慢抬起杠铃")
...
class Ui_QMainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, QMainWindow):
        ...
        self.listView.setGeometry(QtCore.QRect(0, 0, 801, 581))
        self.listView.setStyleSheet("background-image:url(:/pic25.png)")
        self.listView.setObjectName("listView")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(10, 60, 441, 251))
        ...
        self.pushButton.setGeometry(QtCore.QRect(490, 500, 100, 40))
        font = QtGui.QFont()
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(640, 500, 100, 40))
        font = QtGui.QFont()
        font.setFamily("阿里巴巴普惠体")
        font.setPointSize(11)
